...
class RLData(data.base.RLData):
    def __init__(
        ...
        steps = self.grid_world.get_trajectories(**get_trajectories_args, Pi=Pi)
    ...
    def evaluate(
        ...
        with torch.no_grad():
            ...
            for x in loader:
                ...
                metrics = dict(
                    **asdict(metrics), improved_policy_value=improved_policy_value
                )
