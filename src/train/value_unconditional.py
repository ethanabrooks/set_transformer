    ...
    for e in itertools.count():
        ...
        for t, xs in enumerate(train_loader):
            ...
            if step % log_interval == 0:
                ...
                top_rmse = 0.1  # roughly, the maximum RMSE after a few iterations
                progress = top_rmse - epoch_rmse  # make increasing
                progress = min(max(progress, 0), top_rmse) / top_rmse  # normalize
                progress += bellman_number
